  ...
  for (var i = 0; i < pc_link_click.length; i++) {
    pc_link_click[i].addEventListener('click', function (event) {
      ...
      if (targetElement.parentNode.classList.contains('pc-trigger')) {
        ...
        var tc = document.querySelectorAll('li.pc-trigger.pc-hasmenu');
...
function display_alert_sales() {
  ...
  bob.innerHTML += ('<a class="list-group-item list-group-item-action"><div class="d-flex"><div class="flex-shrink-0"><img src="/assets/images/user/avatar-2.jpg" alt="user-image" class="user-avtar"/></div><div class="flex-grow-1 ms-1"><span class="float-end text-muted">Just now</span><h5>Kathy</h5><p class="text-body fs-4">I got your alert, thanks! I have been feeling a bit sick, but will jump on these leads today.</p><div class="badge rounded-pill bg-light-success">Message</div></div></div></a>');
